// =============================================================================
// main.cpp — Entry point for the ab7 TheaterGWD firmware
// =============================================================================
//
// BOOT SEQUENCE:
...
//   The sensor task also feeds the ori_tracker, which determines which
//   saved orientation ("ori") the device is closest to.  Button A saves
//   the current orientation as a new ori.  See ori_tracker.h for details.
// =============================================================================
